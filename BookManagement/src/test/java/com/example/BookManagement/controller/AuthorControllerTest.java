...
class AuthorControllerTest {
    ...
    @Test
    public void testFindSortedAuthorList() throws Exception {
        mockMvc = MockMvcBuilders.standaloneSetup(authorController).build();
        author = new Author();
        author.setAuthor_id(1);
        author.setName("swathy");
        ...
        when(authorService.findSortedAuthorList()).thenReturn((List<AuthorResponse>) authorResponse);
        mockMvc.perform(get("/sort/asc/authors")
                .contentType(MediaType.APPLICATION_JSON)
                .content(asJsonString(author)))
    ...
    @Test
    public void testFindReversedSortedAuthorList() throws Exception {
        mockMvc = MockMvcBuilders.standaloneSetup(authorController).build();
        author = new Author();
        author.setAuthor_id(1);
        author.setName("swathy");
        ...
        when(authorService.findReversedSortedAuthorList()).thenReturn((List<AuthorResponse>) authorResponse);
        mockMvc.perform(get("/sort/desc/authors")
                .contentType(MediaType.APPLICATION_JSON)
                .content(asJsonString(author)))
                // .andExpect(MockMvcResultMatchers.status().isOk())
                .andDo(MockMvcResultHandlers.print());
